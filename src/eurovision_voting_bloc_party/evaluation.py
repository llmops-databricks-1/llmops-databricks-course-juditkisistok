...
stays_in_scope_guideline = Guidelines(
    name="stays_in_scope",
    guidelines=[
        "The response must relate the answer back to Eurovision",
        "If asked about something unrelated, the response must redirect to Eurovision "
        "rather than just answering the off-topic question directly",
        "A response that acknowledges an off-topic question but connects it to Eurovision"
        "is acceptable",
    ],
    model="databricks:/databricks-gpt-oss-120b",
)
